...
#This script defines different threshold functions. To change which threshold function is used, update which of these functions is given as an argument to stabilizePrediction in PENGUIN_Main.
#We use withinNumberThreshold.
...
#'programmaticAccThreshold' is an example of a programmatic threshold functions.
...
def programmaticAccThreshold(array):
    ...
    #threshold=(-9.0/88)*float(median)+10.0+9.0/44
    #threshold should range from .1% to 5%, .1% when 90% accuracy & 5% when 2% accuracy.
